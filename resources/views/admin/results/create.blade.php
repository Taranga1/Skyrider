...
<body>
    <form method="POST" action="/admin/results" id="login-form" class="login-form" autocomplete="off" role="main">
        ...
        <div>
          <label class="label-symbolnumber">
            <input type="number" name="symbolnumber" class="text" name="email" placeholder="Enter Symbol Number" tabindex="1" required />
            <span class="required">Symbol Number</span>
          </label>
        </div>
        
        <div>
          <label>
            <input type="text" class="text" name="gpa" placeholder="Enter GPA" tabindex="2" required />
            <span class="required">GPA</span>
          </label>
          <br>
        </div>
