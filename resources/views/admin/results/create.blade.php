...
<div class="contact-us">
  <form method="POST" action="/result" id="login-form"  autocomplete="off" role="main">
    @csrf
        <input type="number" placeholder="Symbol Number" required name="symbolnumber">
        <input type="text" placeholder="GPA" required name="gpa">
