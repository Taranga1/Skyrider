...
<body>
    <div class='parent'>
        <div class='slider'>
         ...
         <div id='slide1' class='slide1 up1'>SKYRIDER</div>
         <div id='slide2' class='slide2'>SECONDARY</div>
         <div id='slide3' class='slide3'>BOARDING</div>
         <div id='slide4' class='slide4'>SCHOOL</div>
        </div>
       </div>
