          ...
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              @if (Route::has('login'))
                    ...
                    @auth
                    <li class="scroll-to-section"><a href="{{ url('/home') }}" class="font-semibold text-gray-200 hover:text-gray dark:text-white dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Home</a></li>
                    @else
                    <li class="scroll-to-section"><a href="{{ route('login') }}" class="font-semibold text-gray-200 hover:text-gray dark:text-white dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log in</a></li>

                        @if (Route::has('register'))
                        <li class="scroll-to-section"><a href="{{ route('register') }}" class="ml-4 font-semibold text-gray hover:text-gray-900 dark:text-white dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Register</a></li>
                        @endif
                    @endauth
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                ...
                <p>SkyRider School is known for its exceptional educational quality, providing a well-rounded curriculum, experienced faculty, state-of-the-art facilities, and a supportive learning environment that fosters academic, personal, and social growth for students.</p>
